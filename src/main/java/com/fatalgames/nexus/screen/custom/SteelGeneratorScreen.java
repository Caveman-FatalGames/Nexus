...
public class SteelGeneratorScreen extends AbstractContainerScreen<SteelGeneratorMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(NexusMod.MOD_ID,"textures/gui/steel_generator/steel_generator_gui.png");
    ...
    public SteelGeneratorScreen(SteelGeneratorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
