...
public class SteelGeneratorMenu extends AbstractContainerMenu {
    public final SteelGeneratorEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public SteelGeneratorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public SteelGeneratorMenu(int pContainerId, Inventory inv, BlockEntity blockEntity, ContainerData data) {
        super(ModMenuTypes.STEEL_GENERATOR_MENU.get(), pContainerId);
        checkContainerSize(inv, 1);
        this.blockEntity = ((SteelGeneratorEntity) blockEntity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.STEEL_GENERATOR.get());
    }
