...
public class SteelTankScreen extends AbstractContainerScreen<SteelTankMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(NexusMod.MOD_ID,"textures/gui/tank/tank_gui.png");
    private FluidTankRenderer fluidRenderer;

    public SteelTankScreen(SteelTankMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
