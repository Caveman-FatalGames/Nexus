...
public class SteelTankMenu extends AbstractContainerMenu {
    public final SteelTankEntity blockEntity;
    ...
    public SteelTankMenu(int pContainerId, Inventory inv, BlockEntity blockEntity) {
        super(ModMenuTypes.STEEL_TANK_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        this.blockEntity = ((SteelTankEntity) blockEntity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.STEEL_TANK.get());
    }
