...
public class SteelForgeMenu extends AbstractContainerMenu {
    public final SteelForgeEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public SteelForgeMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public SteelForgeMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.STEEL_FORGE_MENU.get(), pContainerId);
        blockEntity = ((SteelForgeEntity) entity);
