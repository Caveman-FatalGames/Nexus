package com.fatalgames.nexus.block.entity.renderer;
...
public class SteelTankEntityRenderer implements BlockEntityRenderer<SteelTankEntity> {
    public SteelTankEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(SteelTankEntity pBlockEntity, float partialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int packedOverlay) {
