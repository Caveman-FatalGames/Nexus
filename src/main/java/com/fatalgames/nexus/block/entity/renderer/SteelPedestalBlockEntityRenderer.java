...
public class SteelPedestalBlockEntityRenderer implements BlockEntityRenderer<SteelPedestalBlockEntity> {
    public SteelPedestalBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(SteelPedestalBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
